...
5. Cached Key
    ...
    - A cached key is a key that was originally created by another @sign user but is now cached on the Secondary Server of another user's @sign as they were given permission to cache it. 
